package org.example.userservice.service;//package org.example.userservice.service;
//
...
//
//        Long userId = userServiceImpl.createUser(name, email, age);
//
...
//                () -> userServiceImpl.createUser(name, email, age)
//        );
//
...
//        IllegalArgumentException exception = assertThrows(
//                IllegalArgumentException.class,
//                () -> userServiceImpl.createUser(invalidName, "test@example.com", 25)
//        );
//
...
//        IllegalArgumentException exception = assertThrows(
//                IllegalArgumentException.class,
//                () -> userServiceImpl.createUser(null, "test@example.com", 25)
//        );
//
//        assertEquals("Name cannot be empty", exception.getMessage());
//    }
...
//        IllegalArgumentException exception = assertThrows(
//                IllegalArgumentException.class,
//                () -> userServiceImpl.createUser("J", "test@example.com", 25)
//        );
//
...
//        IllegalArgumentException exception = assertThrows(
//                IllegalArgumentException.class,
//                () -> userServiceImpl.createUser(longName, "test@example.com", 25)
//        );
//
//        assertTrue(exception.getMessage().contains("Name must contain between 2 and 100 characters"));
//    }
...
//        IllegalArgumentException exception = assertThrows(
//                IllegalArgumentException.class,
//                () -> userServiceImpl.createUser("John Doe", invalidEmail, 25)
//        );
//
...
//        IllegalArgumentException exception = assertThrows(
//                IllegalArgumentException.class,
//                () -> userServiceImpl.createUser("John Doe", null, 25)
//        );
//
//        assertEquals("Email cannot be empty", exception.getMessage());
//    }
...
//        IllegalArgumentException exception = assertThrows(
//                IllegalArgumentException.class,
//                () -> userServiceImpl.createUser("John Doe", longEmail, 25)
//        );
//
...
//        IllegalArgumentException exception = assertThrows(
//                IllegalArgumentException.class,
//                () -> userServiceImpl.createUser("John Doe", "john@example.com", null)
//        );
//
...
//        IllegalArgumentException exception = assertThrows(
//                IllegalArgumentException.class,
//                () -> userServiceImpl.createUser("John Doe", "john@example.com", -5)
//        );
//
...
//        IllegalArgumentException exception = assertThrows(
//                IllegalArgumentException.class,
//                () -> userServiceImpl.createUser("John Doe", "john@example.com", 121)
//        );
//
...
//
//        // Test minimum age
//        assertDoesNotThrow(() -> userServiceImpl.createUser(name, "test1@example.com", 0));
//
//        // Test maximum age
//        assertDoesNotThrow(() -> userServiceImpl.createUser(name, "test2@example.com", 120));
//    }
//
...
//                IllegalArgumentException.class,
//                () -> userServiceImpl.getUserById(0L)
//        );
...
//
//        boolean result = userServiceImpl.updateUser(userId, "New Name", "new@example.com", 30);
//
//        assertTrue(result);
...
//        when(userDao.findById(userId)).thenReturn(Optional.of(existingUser));
//
//        boolean result = userServiceImpl.updateUser(userId, "New Name", null, null);
//
//        assertTrue(result);
//        assertEquals("New Name", existingUser.getName());
...
//        when(userDao.findById(userId)).thenReturn(Optional.of(existingUser));
//
//        boolean result = userServiceImpl.updateUser(userId, null, null, 30);
//
//        assertTrue(result);
...
//        when(userDao.findById(userId)).thenReturn(Optional.of(existingUser));
//
//        boolean result = userServiceImpl.updateUser(userId, "New Name", "john@example.com", 30);
//
//        assertTrue(result);
...
//        IllegalArgumentException exception = assertThrows(
//                IllegalArgumentException.class,
//                () -> userServiceImpl.updateUser(userId, "New Name", "taken@example.com", 30)
//        );
//
...
//        IllegalArgumentException exception = assertThrows(
//                IllegalArgumentException.class,
//                () -> userServiceImpl.updateUser(userId, "J", null, null) // too short name
//        );
//
//        assertTrue(exception.getMessage().contains("Name must contain between 2 and 100 characters"));
//        verify(userDao, never()).update(any(User.class));
